...
BEGIN
    ...
    INSERT INTO Comenzi(id_comanda) VALUES(1);
    ...
    BEGIN
        ...
        SELECT COUNT(Produse_nr_produs) INTO produs_in_reteta FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Ursus 330 ml');
        ...
        IF (produs_in_reteta > 0) THEN
            ...
            SET stoc_ingredient = stoc_ingredient - produse_comandate * (SELECT r.cantitate_ingredient FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Ursus 330 ml') and r.Ingrediente_id_ingredient = i.id_ingredient)
            WHERE EXISTS (SELECT 1 FROM Reteta r WHERE Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Ursus 330 ml') and r.Ingrediente_id_ingredient = i.id_ingredient);
    ...
    BEGIN
        ...
        SELECT COUNT(Produse_nr_produs) INTO produs_in_reteta FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Cotlet de porc la gratar');
        ...
        IF (produs_in_reteta > 0) THEN
            UPDATE Ingrediente i
            SET stoc_ingredient = stoc_ingredient - produse_comandate * (SELECT r.cantitate_ingredient FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Cotlet de porc la gratar') and r.Ingrediente_id_ingredient = i.id_ingredient)
            WHERE EXISTS (SELECT 1 FROM Reteta r WHERE Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Cotlet de porc la gratar') and r.Ingrediente_id_ingredient = i.id_ingredient);
        ELSIF (produs_in_stoc > 0) THEN
            UPDATE stocuri_produs sp
            SET stoc_produs = stoc_produs - produse_comandate
...
BEGIN
    ...
    INSERT INTO Comenzi(id_comanda) VALUES(2);
    ...
    BEGIN
        ...
        SELECT COUNT(Produse_nr_produs) INTO produs_in_reteta FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Supa cu legume');
        ...
        IF (produs_in_reteta > 0) THEN
            UPDATE Ingrediente i
            SET stoc_ingredient = stoc_ingredient - produse_comandate * (SELECT r.cantitate_ingredient FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Supa cu legume') and r.Ingrediente_id_ingredient = i.id_ingredient)
            WHERE EXISTS (SELECT 1 FROM Reteta r WHERE Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Supa cu legume') and r.Ingrediente_id_ingredient = i.id_ingredient);
        ELSIF (produs_in_stoc > 0) THEN
            UPDATE stocuri_produs sp
            SET stoc_produs = stoc_produs - produse_comandate
...
BEGIN
    ...
    INSERT INTO Comenzi(id_comanda) VALUES(3);
    ...
    BEGIN
        ...
        SELECT COUNT(Produse_nr_produs) INTO produs_in_reteta FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Suc portocale 330 ml');
        ...
        IF (produs_in_reteta > 0) THEN
            UPDATE Ingrediente i
            SET stoc_ingredient = stoc_ingredient - produse_comandate * (SELECT r.cantitate_ingredient FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Suc portocale 330 ml') and r.Ingrediente_id_ingredient = i.id_ingredient)
            WHERE EXISTS (SELECT 1 FROM Reteta r WHERE Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Suc portocale 330 ml') and r.Ingrediente_id_ingredient = i.id_ingredient);
        ELSIF (produs_in_stoc > 0) THEN
            UPDATE stocuri_produs sp
            SET stoc_produs = stoc_produs - produse_comandate
...
BEGIN
    ...
    INSERT INTO Comenzi(id_comanda) VALUES(4);
    ...
    BEGIN
        ...
        SELECT COUNT(Produse_nr_produs) INTO produs_in_reteta FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Pizza cu piept de pui');
        ...
        IF (produs_in_reteta > 0) THEN
            UPDATE Ingrediente i
            SET stoc_ingredient = stoc_ingredient - produse_comandate * (SELECT r.cantitate_ingredient FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Pizza cu piept de pui') and r.Ingrediente_id_ingredient = i.id_ingredient)
            WHERE EXISTS (SELECT 1 FROM Reteta r WHERE Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Pizza cu piept de pui') and r.Ingrediente_id_ingredient = i.id_ingredient);
        ELSIF (produs_in_stoc > 0) THEN
            UPDATE stocuri_produs sp
            SET stoc_produs = stoc_produs - produse_comandate
...
BEGIN
    ...
    INSERT INTO Comenzi(id_comanda) VALUES(5);
    ...
    BEGIN
        ...
        IF (produs_in_reteta > 0) THEN
            UPDATE Ingrediente i
            SET stoc_ingredient = stoc_ingredient - produse_comandate * (SELECT r.cantitate_ingredient FROM Reteta r WHERE r.Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Limonada 330 ml') and r.Ingrediente_id_ingredient = i.id_ingredient)
            WHERE EXISTS (SELECT 1 FROM Reteta r WHERE Produse_nr_produs = (SELECT nr_produs FROM Produse WHERE nume_produs = 'Limonada 330 ml') and r.Ingrediente_id_ingredient = i.id_ingredient);
        ELSIF (produs_in_stoc > 0) THEN
            UPDATE stocuri_produs sp
            SET stoc_produs = stoc_produs - produse_comandate

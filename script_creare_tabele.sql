...
ALTER TABLE administratori ADD CONSTRAINT administratori_nume_parola_un UNIQUE ( nume_prenume_cont,
                                                                                 parola_cont );
...
CREATE OR REPLACE TRIGGER trg_data_crearii_categorii 
    BEFORE INSERT OR UPDATE ON Categorii 
    FOR EACH ROW 
BEGIN
...
CREATE OR REPLACE TRIGGER trg_data_crearii_ingrediente 
